                ...
                <div class="section__container">
                    ...
                    <div class="adminforms">
                        <div class="adminform">
                            <h4 class="section__title">${x.type}</h4><br>
                                <div class="form-group">
                                    <label for="category">Updated Category :</label>
                        ...
                        <div class="categorybutton">
                            ...
                            <li class="menu__item">
                                <a href="category/delete/${x.id}" class="header__action button display-none display-block-lg button_color_accent" href="/delete/category/{}" onclick="gtag('event', 'Click', {'event_category' : 'Header CTA', 'event_label' : 'Request an Appointment button', 'event_value' : '375'});">
                                    Delete </a> 
                            </li>
                            </ul>
                        </div>
