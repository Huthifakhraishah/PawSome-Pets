         ...
         <div class="section section_toolbar">
            ...
            <section class="section section_widget_highlight-grid section_theme_shade ">
                <div class="section__container">
                    ...
                    <form action="/categories/${x.id}/edit" method="post">
                    <div class="adminforms">
                        <div class="adminform">
                            <h4 class="section__title">${x.type}</h4><br>
                                <div class="form-group">
                                    <label for="type">Updated Category :</label>
                        ...
                        <div class="categorybutton">
                            ...
                            <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
                                <input type="submit" value="Edit Category" class="button button_color_accent">
                            </li>
                            <li class="menu__item">
                                <a href="categories/delete/${x.id}" class="header__action button display-none display-block-lg button_color_accent" href="/delete/category/{}" onclick="gtag('event', 'Click', {'event_category' : 'Header CTA', 'event_label' : 'Request an Appointment button', 'event_value' : '375'});">
                                    Delete </a> 
                            </li>
                            </ul>
                        </div>
