               ...
               <div class="grid grid_tile flex-justify-center">
                  <div class="grid__item grid__item_fill ">
                     <div class="card card_provider-full card_link card_zoom card_tall text-align-center">
                        <img class="lazy card__image loaded ourphotos" data-src="/site/assets/files/8168/dr__erica_capshaw_brooks.244x288n.jpg" alt="Erica Capshaw Brooks, DVM" src="/images/haitham.jpg" data-was-processed="true">
                        <div class="card__body gap-y-xs">
                           <h3 class="card__title"><span>Haitham Estetieh</span></h3>
                        </div>
                     </div>
                  </div>
                  <div class="grid__item grid__item_fill ">
                     <div class="card card_provider-full card_link card_zoom card_tall text-align-center">
                        <img class="lazy card__image loaded ourphotos" data-src="/site/assets/files/8212/dr__alexandra_carter.244x288n.jpg" alt="Alexandra Carter, DVM" src="/images/huthaifa.jpg" data-was-processed="true">
                        <div class="card__body gap-y-xs">
                           <h3 class="card__title"><span>Huthifa Khraishah</span></h3>
                        </div>
                     </div>
                  </div>
                  <div class="grid__item grid__item_fill ">
                     <div class="card card_provider-full card_link card_zoom card_tall text-align-center">
                        <img class="lazy card__image loaded ourphotos" data-src="/site/assets/files/8201/dr__kristin_ballard.244x288n.jpg" alt="Kristen Rought, DVM" src="/images/qamar.jpg" data-was-processed="true">
                        <div class="card__body gap-y-xs">
                           <h3 class="card__title"><span>Qamar Dajani</span></h3>
                        </div>
                     </div>
                  </div>
                  <div class="grid__item grid__item_fill ">
                     <div class="card card_provider-full card_link card_zoom card_tall text-align-center">
                        <img class="lazy card__image loaded ourphotos" data-src="/site/assets/files/6561/tiffany_killian-1.244x288n.jpeg" alt="Tiffany Killian, DVM" src="/images/yousef.jpg" data-was-processed="true">
                        <div class="card__body gap-y-xs">
                           <h3 class="card__title"><span>Yousef Swailem</span></h3>
                        </div>
                     </div>
                  </div>
               </div>
