...
<title>Admin Dashboard</title>
        ...
        <script async="" src="/js/roundtrip.js"></script>
        <script src="/js/2511126609209221.js" async=""></script>
        ...
        <div role="main">
            ...
            <div class="section__container">
                <div class="section__intro">
                    <h2 class="section__title">Admin Page</h2>
                </div><br>
                
				<div class="adminforms">
                    <div class="adminform">
                        <h4 class="section__title">Adding Categories</h4><br>
                        <p class="errorMessagesInYellow"><c:out value="${addingCategoriesErrorMessage}"/></p>
                        <form action="/admin/createCategory" method="post">
                            <div class="form-group">
                                <label for="category">Type</label><br><br>
                                 <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
                                <input type="text" class="form-control"  placeholder="Enter category" name="type">
                            </div><br>
                            <input type="submit" value="Add Category" class="button button_color_accent">
                        </form>
                    </div><br><br>
                    
                    <div class="adminform">
                        <h4 class="section__title">Adding Services</h4><br>
						<p class="errorMessagesInYellow"><c:out value="${addingPServicesErrorMessage}"/></p>
                        <form action="/admin/createPService" method="post">
                            <div class="form-group">
                    ...
                    <div class="adminform">
                        <h4 class="section__title">Adding Appointments</h4><br>
                        <p class="errorMessagesInYellow"><c:out value="${addingAppointmentsErrorMessage}"/></p>
                        <form action="/admin/createAppointment" method="post">
                            <div class="form-group">
                                <label for="appointment">Date</label><br><br>
                                <input type="date" class="form-control" name="appointment">
                                </div><br>
                                <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
                                <input type="submit" value="Add Appointment" class="button button_color_accent">
                        </form>
                    </div>
                </div>
