...
<link rel="canonical" href="https://petcarecenterinc.com/">
    ...
    <script type="application/ld+json">
        {
            ...
            "url": "https://petcarecenterinc.com/",
            "sameAs": ["https://www.linkedin.com/company/pet-care-center-veterinary-hospitals/about/"]
        }
    </script>
    ...
    <script>
        ...
        })(window, document, 'script', 'dataLayer', 'GTM-NZ6WKBM')
    </script>
    <script>
        (function(w, d, s, l, i) {
            w[l] = w[l] || [];
            ...
            j.src = 'https://www.googletagmanager.com/gtm.js?id=' + i + dl;
            f.parentNode.insertBefore(j, f)
        })(window, document, 'script', 'dataLayer', 'GTM-PHXGT5T')
    </script>
        ...
        <div class="accentbar">
            ...
            <div>
                <div class="grid grid_tile flex-justify-center" style=" margin: auto;">
                    <div style="width: 55%;">
                        <img class="radius align_right lazy service_img loaded" alt="Kristen Rought, DVM" src="${myPet.links}" data-was-processed="true" id="thumbnailForService"">
                        <div style="font-size: xx-large;">
                            <h2><c:out value="${myPet.name}"/></h2>
                        </div>
                        <br>
                        <br>
                        <h2>Added Services:</h2>
                        <p style="margin-bottom: 5%;">
                        <c:forEach items="${myPetServices}" var="myPetService"> 
                         <p> - <c:out value="${myPetService.name}"/></p>
                        </c:forEach>
                ...
                <div><br><br>
                        ...
                        <div class="section__container">
                            ...
                            <div class="section__intro">
                                ...
                                <div class="section__intro gap-y">
                                    <h2 class="section__title">Request an Appointment</h2>
                                </div>
					...
					<c:choose>  
				    <c:when test="${isAdmin==true}">  
<a class="button button_color_accent" href="/editservice" onclick="gtag('event', 'Click', {'event_category' : 'Erica Capshaw Brooks, DVM Section CTA', 'event_label' : 'Find a Location button', 'event_value' : '375'})">
                Edit/Delete</a>				    
                </c:when>  
                  <c:when test="${isAdmin!=true && isGuest==false}">  
			    </c:when>  		
